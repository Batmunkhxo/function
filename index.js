...
function heightOfTriangle(number1, number2){
    return number1 * number2;
}
console.log(heightOfTriangle(10, 12));
...
function stringLenght(Alchohol){
    return Alchohol.length
}
console.log(stringLenght("Alchohol"))
// write a function that takes a string as argument and returns it to number
function stringReturnsNumber(Quantity){
    return Number(Quantity)
};
let result = stringReturnsNumber("214324")
console.log(result)
// write a function that takes a number as argument and returns it to string
function numberReturnstoNumber(num){
    let text=num.toString();
return text;
}
console.log(numberReturnstoNumber(75));
